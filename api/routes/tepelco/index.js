...
routerTepelco.post('/', function(req, res) {
  ...
  [req.body.dp_cartucho,req.body.dp_filtro,req.body.ciclo_ev1,req.body.ciclo_ev2,req.body.ciclo_ev3,req.body.ciclo_ev4,req.body.ciclo_ev5,req.body.ciclo_ev6,req.body.ciclo_ev7,req.body.ciclo_ev8,0], function(err, result, fields) {
      if (err) {
